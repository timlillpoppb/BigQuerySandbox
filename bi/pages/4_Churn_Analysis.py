...
c4.metric("Net Subscriber Change", f"{int(latest.new_subscribers - latest.churned_subscribers):+,}")
...
df_mrr = df_total.tail(6)[["cohort_month","total_mrr","new_mrr","churned_mrr","retained_mrr","expansion_mrr"]].copy()
...
df_mrr_disp.columns = ["Month","Total MRR","New MRR","Churned MRR","Retained MRR","Expansion MRR"]
